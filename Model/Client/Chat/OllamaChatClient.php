...
/**
 * Ollama reasoning / chat-completion client.
 *
 * Example:
 *
 *   $client = $this->ollamaChatClientFactory->create([
 ...
 * @since 1.0.0
 */
class OllamaChatClient extends AbstractChatClient
{
    /** Model code */
    ...
    public function isAvailable(): bool
    {
        ...
        try {
            ...
            $this->logger->debug('[ollama][chat] isAvailable failed: ' . $e->getMessage());
            return false;
        }
    }
}
